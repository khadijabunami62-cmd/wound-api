...
قواعد التنسيق الإجبارية (هامة جداً):
- يجب أن تبدأ كل فقرة وكل نقطة مرقمة برمز (\u200f) فوراً قبل أي حرف أو رقم.
- استخدم الأرقام العربية الشرقية (١- ، ٢- ، ٣- ).
- اترك سطرين فارغين (Double Newline) بين كل نقطة والتي تليها لضمان عدم تراكم النص.
- تأكد أن كل نقطة تبدأ في سطر جديد تماماً.# بدلاً من الجملة العادية، استخدمي هذا التوصيف لضمان الانفصال التام:
"- إجباري: ابدأ كل نقطة مرقمة في سطر جديد، واحرص على ترك سطر فارغ تماماً بين نهاية النقطة السابقة وبداية الرقم الجديد (Double Line Break)."
